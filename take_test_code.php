...
<section id="forms">
  ...
  <div class="row">
    <div class="span10 offset1">
      <form class="form-horizontal well" method="post" action="test_RULES.php">
        <fieldset>
...
$query = mysql_query("select * from test_pool where test_id not in (select test_id from user_gradebook_code where stu_id=$_SESSION[user_id])");
//$j = 1;
while($info = mysql_fetch_array($query))
{
echo '<br>'.'('.$info['test_id'].')'.$info['test_name'].'----'.$info['date_created'].'<br>';
//$j++;
}
...
?>
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <input type="text" class="input-xlarge" id="i01" name="test">
