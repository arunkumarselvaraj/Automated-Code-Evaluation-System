...
$query_display = mysql_query("select * from test_pool_sql natural join user_gradebook_Query where staff_id='$_SESSION[user_id]'") or die ('in fetch error::'.mysql_error());
$i=1;
