...
<section id="forms">
  ...
  <div class="row">
    <div class="span10 offset1">
      <form class="form-horizontal well" action="staff_mcq_score.php" method="POST">
        <fieldset>
...
$auth->connect();
$res=mysql_query("SELECT test_id FROM score") or die("sdfcd");   //change
...
?>            
            ...
            <input type="submit" class="btn btn-primary" name="submit" value="View Score"/>
