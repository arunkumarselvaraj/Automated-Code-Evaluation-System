...
<section id="forms">
  ...
  <div class="row">
    <div class="span10 offset1">
      <form class="form-horizontal well" action="get_score.php" method="post" enctype="multipart/form-data">
        <fieldset>
 <?php
// Values confirmed. Can enter into the db now.
//error_reporting(E_ALL);
//ini_set('display_errors','1');
//session_start();
$array=explode(',',$_SESSION['qno']);
//echo $array[0];
$num=count($array);
$auth->connect();
   $query = "INSERT INTO test(test_id,title,start_date,start_time,duration) VALUES ('$array[0]','$array[1]','$array[2]','$array[3]','$array[4]')";
$res=mysql_query($query);
if(!$res) {echo ' This test_id already exists'; exit;}
for($i=5;$i<$num;$i++)
   {
     $r=mysql_query("INSERT INTO test_feed(test_id,ques_id) VALUES('$array[0]','$array[$i]')");
...
?>
 ...
 <label class="control-groups" > Test Created.</label>
          <div class="form-actions">
            <button type="submit" class="btn btn-primary" formaction="enter_pool.php">Add question to pool</button>
            <button type="submit" class="btn btn-primary" formaction="test_maker.php">Create another test</button>
