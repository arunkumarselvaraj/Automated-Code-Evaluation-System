...
<section id="forms">
  <div class="page-header">
    <h1>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Test Creation Successful</h1>
  </div>

  <div class="row">
    <div class="span10 offset1">
      <form class="form-horizontal well" method="post" action="ans_code.php">
        <fieldset>
          
          <div class="control-group">
            <label class="control-label" for="textarea"> Tests</label>
            <div class="controls">
              <p>
            <?php
...
$see = $_POST['no_pr'];
$pick=mysql_query("select * from problem_pool order by rand() limit $see") or die(mysql_error());
...
mysql_query( "insert into test_pool_sql(test_name,staff_id) values ('$test_name','$_SESSION[user_id]')" ) or die("ERR:".mysql_error());
$curr_test_id=mysql_result(mysql_query("select max(test_id) from test_pool_sql") ,0);

while($info = mysql_fetch_array($pick) )
{
echo "..................";
echo "<br>...".$info['pid']."...<br>";
mysql_query("insert into test_prob_sql values('$curr_test_id','$info[pid]')") or die("ERR::::::".mysql_error());
$i++;
}
